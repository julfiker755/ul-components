...
const Sidebar: React.FC<SidebarProps> = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0  top-0 z-[99999999] flex h-screen  w-72.5 flex-col overflow-y-hidden border-2 duration-300 ease-linear text-black w-[240px] lg:static lg:translate-x-0 ${
